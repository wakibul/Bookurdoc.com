 ...
 <div class="container">
            ...
            <div class="row row-cards">
              ...
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="card">
                  <div class="card-body p-3 text-center">
                    <div class="h1 m-0">{{franchiseBooking()}}</div>
                    <div class="text-muted mb-4">Franchise Booking</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="card">
                  <div class="card-body p-3 text-center">
                    <div class="h1 m-0">{{guestBooking()}}</div>
              ...
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="card">
                  <div class="card-body p-3 text-center">
                    ...
                    <div class="h1 m-0">{{totalFranchise()}}</div>
