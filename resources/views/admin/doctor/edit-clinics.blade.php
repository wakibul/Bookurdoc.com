  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form action="{{route('admin.doctor.udpate_fees',Crypt::encrypt($doctor->id))}}" action="" method="post">
              @csrf
            <table class="table">
            ...
            <tr>
                ...
                <td>Doctor Fees <input type="number" name="doctor_fees[]" class="form-control" required value="{{$doctor->fees[$key]->doctor_fees}}">
                <input type="hidden" name="clinic_id[]" class="form-control" value="{{$doctor->fees[$key]->clinic_id}}">
                </td>
                <td>Booking Fees <input type="number" name="booking_charge[]" class="form-control" required value="{{$doctor->fees[$key]->booking_charge}}"></td>
                <td>Agent Fees <input type="number" name="agent_charge[]" class="form-control" required value="{{$doctor->fees[$key]->agent_charge}}"></td>
            </tr>
            @empty
            <tr><td colspan="4">
            No clinics found
