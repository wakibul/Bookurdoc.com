...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        $appointments = BookingDetail::orderBy('id', 'desc')->paginate(30);
    ...
    public function filter(Request $request)
    {
        ...
        if (!empty($request->doctor)) {
            if ($request->doctor == "all") {
                $appointments = BookingDetail::whereDate('booking_date', $request->date)->orderBy('id', 'desc')->paginate(30);
            } else {
                $appointments = BookingDetail::where('doctor_id', $request->doctor)->whereDate('booking_date', $request->date)->orderBy('id', 'desc')->paginate(30);
            }
        }
    ...
    public function showPatient(Request $request)
    {
        ...
        $bookingDetails = $bookingDetails->get();
